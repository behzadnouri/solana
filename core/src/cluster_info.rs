...
struct GossipStats {
    ...
    handle_pull_requests_time: Counter,
    ...
    handle_pull_requests_no_budget: Counter,
    ...
    fn handle_pull_requests(
        ...
        let responses = self
            ...
            .flat_map(|(caller, requests)| {
                let packets = self.make_pull_response_packets(requests, output_size_limit, now);
            ...
            .flat_map(move |(from_addr, responses)| {
                Self::split_gossip_messages(PULL_RESPONSE_MAX_PAYLOAD_SIZE, responses)
                    ...
                    .filter_map(move |response| {
                        ...
                        match Packet::from_data(&from_addr, response) {
                            Err(err) => {
        ...
        if last_print.elapsed().as_millis() > 2000 {
            ...
            datapoint_info!(
                ...
                (
                    ...
                    self.stats.handle_pull_requests_time.clear(),
                    i64
                ),
                (
                ...
                (
                    ...
                    self.stats.handle_pull_requests_no_budget.clear(),
                    i64
                ),
