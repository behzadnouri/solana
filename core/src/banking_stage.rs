...
impl BankingStage {
    ...
    pub fn process_packets(
        ...
        info!("#{}) packets received: {}", id, count);
        info!(
        ...
        // XXX Uncommeting these lines breaks the cluster:
        ...
        // Compute these once for the entire while loop!
