...
impl CrdsGossipPull {
    ...
    fn pull_options(
        ...
        stakes: &HashMap<Pubkey, u64>,
        socket_addr_space: &SocketAddrSpace,
    ) -> Vec<(/*weight:*/ u64, LegacyContactInfo)> {
        let mut rng = rand::thread_rng();
        ...
        crds.get_nodes()
            ...
            .filter(|v| {
                v.id != *self_id
                    && LegacyContactInfo::is_valid_address(&v.gossip, socket_addr_space)
    ...
    pub(crate) fn filter_pull_responses(
        ...
        let upsert = |response: CrdsValue| {
            ...
            // Before discarding this value, check if a LegacyContactInfo for the
            ...
            if !crds.upserts(&response) {
                ...
                None
            } else if crds.get::<&LegacyContactInfo>(owner).is_some() {
...
pub(crate) mod tests {
    ...
    fn test_new_pull_with_stakes() {
        ...
        let me = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
            LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0),
        ));
    ...
    fn test_no_pulls_from_different_shred_versions() {
        ...
        let me = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(LegacyContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 123,
            gossip,
            ..LegacyContactInfo::default()
        }));
        let spy = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(LegacyContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 0,
            gossip,
            ..LegacyContactInfo::default()
        }));
        let node_123 = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(LegacyContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 123,
            gossip,
            ..LegacyContactInfo::default()
        }));
        let node_456 = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(LegacyContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 456,
            gossip,
            ..LegacyContactInfo::default()
    ...
    fn test_new_pull_request() {
        ...
        let entry = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
            LegacyContactInfo::new_localhost(&node_keypair.pubkey(), 0),
        ));
        let node = CrdsGossipPull::default();
        ...
        let new = LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), now);
        ping_cache
            .lock()
            .unwrap()
        ...
        let offline = LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), now);
    ...
    fn test_new_mark_creation_time() {
        ...
        let old = LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0);
        ...
        crds.insert(old.clone(), now, GossipRoute::LocalMessage)
            .unwrap();
        let new = LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0);
    ...
    fn test_generate_pull_responses() {
        ...
        let new = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
            LegacyContactInfo::new_localhost(
        ...
        filters.extend({
            ...
            let caller = LegacyContactInfo::new_localhost(&Pubkey::new_unique(), now);
    ...
    fn test_process_pull_request_response() {
        ...
        let mut node_crds = Crds::default();
        let entry = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
            LegacyContactInfo::new_localhost(&node_keypair.pubkey(), 1),
        ));
        let caller = entry.clone();
        ...
        let new = LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 1);
        ping_cache.mock_pong(new.id, new.gossip, Instant::now());
        let new = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(new));
        node_crds.insert(new, 0, GossipRoute::LocalMessage).unwrap();
        ...
        let new = LegacyContactInfo::new_localhost(&new_id, 1);
        ping_cache.mock_pong(new.id, new.gossip, Instant::now());
        let new = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(new));
        dest_crds
        ...
        let same_key = LegacyContactInfo::new_localhost(&new_id, 0);
    ...
    fn test_gossip_purge() {
        ...
        node_crds
            .insert(entry, 0, GossipRoute::LocalMessage)
            .unwrap();
        let old = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
            LegacyContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0),
        ));
        node_crds
    ...
    fn test_process_pull_response() {
        ...
        let peer_entry = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
            LegacyContactInfo::new_localhost(&peer_pubkey, 0),
        ));
